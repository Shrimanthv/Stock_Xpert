...
# installed.
TCL_PREFIX='D:/stock_price_prediction_system/stock_env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/stock_price_prediction_system/stock_env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/stock_price_prediction_system/stock_env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/stock_price_prediction_system/stock_env\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/stock_price_prediction_system/stock_env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/stock_price_prediction_system/stock_env\Library\lib\tclstub86.lib'
